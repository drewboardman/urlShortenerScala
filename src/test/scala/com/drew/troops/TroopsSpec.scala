...
class TroopsSpec extends org.specs2.mutable.Specification {
  ...
  private[this] val retHelloWorld: Response[IO] = {
    ...
    val helloWorld = Troops.impl[IO]
    TroopsRoutes.helloWorldRoutes(helloWorld).orNotFound(getHW).unsafeRunSync()
  }
